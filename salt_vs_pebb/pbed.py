...
while max(size_bins_R,size_bins_Z) > 2*pebble_rad[-1]:
    ...
    string+='det flux_{} dx {} {} {} dy {} {} {} dz {} {} {} dm Flibe924\n'.format(Nr,-rad_core-pebble_rad[-1],rad_core+pebble_rad[-1],Nr,-rad_core-pebble_rad[-1],rad_core+pebble_rad[-1],Nr,zmin-pebble_rad[-1],zmax+pebble_rad[-1],int(Nr*height/diam))    
    det_file.write(string)
    Nr+=1
    size_bins_R=(diam+2*pebble_rad[-1])/Nr                                                                                                                                                                      
    size_bins_Z=(height+2*pebble_rad[-1])/(int(Nr*height/diam))   
